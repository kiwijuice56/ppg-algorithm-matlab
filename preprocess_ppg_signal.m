...
%PREPROCESS_PPG_PULSE Returns a processed copy of a raw PPG signal (red 
...
recording_length = (recording_end - recording_start) / 1000.0; % Seconds
new_sample_count = new_sampling_frequency * recording_length;

scaled_timestamps = linspace(recording_start, recording_end, new_sample_count);
processed_ppg_signal = interp1(timestamps, processed_ppg_signal, scaled_timestamps, 'pchip');
